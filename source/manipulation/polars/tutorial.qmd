...
## Tidypolars
Pour celles et ceux qui veulent utiliser des fonctions pressqu'identiques à celles du tidyverse,
...
En effet, si on sélectionnait 2 colonnes, cela serait aussi dataframe.
...
Il faut donc faire ces étapes soi-même pour le moment grâce aux packages `requests`et `zipfile`.
